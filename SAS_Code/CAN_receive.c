...
void CAN1_send_channel()  // 使用CAN1发送遥控信息
{
	...
	if (is_x_pressed)
	{
		data_u.data.channel_0 = data_u.data.channel_0 | 4; //减小摩擦轮转速
	}
...
//		data_u.data.keyboard = (data_u.data.keyboard | 1);
	...
	// LYL
	//usart_printf("%d,%d,%d,%d,%d\r\n", data_u.data.channel_0,data_u.data.channel_2,data_u.data.channel_3,data_u.data.keyboard,data_u.data.mode);
